...
sillyGirl()
{
    ...
    #获取dev.go文件
    echo "下载dev.go文件"
    wget https://ghproxy.com/https://raw.githubusercontent.com/ZQCCBOY/sillyGirl-/main/dev.go
    #进入develop文件夹
    if [[ $? == 0 ]]; then
        sleep 3s
        cd develop;
    ...
    #克隆一些必要的库
    git clone https://ghproxy.com/https://github.com/ZQCCBOY/fanli_jd.git;
    git clone https://ghproxy.com/https://github.com/ZQCCBOY/fanli_tb.git;
    git clone https://ghproxy.com/https://github.com/ZQCCBOY/fanli_pdd.git;
    git clone https://ghproxy.com/https://github.com/ZQCCBOY/fanli_vip.git;
